...
public sealed class RunDolOptionsTests
{
    ...
    public void ParsesTraceAndMmioOptions()
    {
        ...
        bool parsed = RunDolOptions.TryParse(
            ["run-dol", "game.dol", "--max-instructions", "42", "--trace-file", "traces/game.trace", "--trace-tail", "8", "--dump-mmio", "--dump-threads", "--dump-message-queues", "--dump-memory", "0x80002000", "0x40", "--dump-memory", "0x803E7800", "0x20", "--dump-disasm", "0x80BC82A0", "0x10", "--dump-pointer-table", "0x80B0E4A0", "0x500", "0x18", "0x0C", "4", "--dump-frame", "frames/game.png", "--dump-gx-frame", "frames/gx.png", "--dump-gx-frame-sweep", "frames/sweep", "10", "25", "4", "--gx-frame-source", "last-display-copy", "--gx-frame-copy-index", "428", "--gx-frame-max-draws", "77", "--gx-frame-skip-draws", "11", "--gx-frame-max-raster-pixels", "12345", "--gx-frame-ignore-efb-copy-clear", "--dump-gx-draws", "frames/gx-draws.txt", "--dump-gx-copies", "frames/gx-copies.csv", "--dump-gx-copy-events", "frames/gx-copy-events.csv", "--dump-gx-coverage", "frames/gx-coverage.csv", "--dump-gx-tev-samples", "frames/gx-tev-samples.csv", "--dump-gx-textures", "frames/gx-textures", "--gx-draw-skip-draws", "600", "--gx-draw-max-draws", "42", "--trace-gx-fifo-writes", "frames/gx-writes.csv", "--gx-memory-checkpoint", "0x84EF0", "0x0060E4A0", "0x20000", "frames/checkpoints/draw790.bin", "--gx-disable-auto-texture-snapshots", "--trace-exi", "traces/exi.csv", "--trace-si", "traces/si.csv", "--trace-mmio", "traces/mmio.csv", "--trace-scheduler", "traces/scheduler.csv", "--run-summary", "traces/run-summary.json", "--memory-card-a", "--memory-card-b", "--frame-address", "0x80010000", "--frame-width", "320", "--frame-height", "240", "--frame-format", "rgb565", "--watch-address", "0x800000E4", "--watch-write-value", "0x20000", "--watch-write-range", "0x803E78A0", "0x40", "--watch-write-after", "0x5000", "--watch-load-range", "0x80225180", "0x100", "--stop-after-write-watch", "0x20", "--watch-call-target", "0x80012280", "--watch-call-target", "0x802A5D14", "--watch-call-range", "0x80012000", "0x1000", "--find-memory-word", "0x00020000", "--find-memory-word", "0x802A5D14", "--watch-gpr", "r31", "--watch-gpr-after", "0x300", "--fast-forward-idle", "--fast-forward-write-watch", "--trace-prs-decompress", "--trace-sonic-path-lookup", "traces/sonic-path.csv", "--trace-sonic-resource-flags", "traces/sonic-flags.csv", "--di-command-latency-cycles", "0x4000", "--controller-button", "start", "--controller-button", "b+x", "--controller-button-window", "a", "100", "200", "--watch-limit", "0x10", "--profile-pc", "12", "--profile-after", "0x123456", "--profile-indirect-call-site", "0x801B1348", "8", "--profile-branch-site", "0x800E3128", "6", "--profile-pc-lr", "0x800E78AC", "5", "--stop-on-pc", "0x801F58D4", "--stop-on-pc-after", "0x1234", "--trace-pc", "0x800D2684", "--trace-pc", "0x800D2694", "--trace-pc-after", "0x4567", "--stop-on-gx-fifo-offset", "0x84EF0", "--stop-on-hot-pc", "0x100", "--stop-on-hot-pc-after", "0x200", "--no-registers"],
