...
Start here if you are new to ngcSharp:

- [Architecture overview](architecture.md): project layout, execution model, devices, and rendering diagnostics.
...
- [GameCube emulator plan](gamecube-emulator-plan.md)
- [Retail benchmark notes](retail-benchmarks.md)
- [GX fixtures](gx-fixtures.md)
- [Demo sweep](demo-sweep.md)
- [Test DOLs](test-dols.md)
