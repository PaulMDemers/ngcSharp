...
- Re-run the Sonic resource profile after external-interrupt helper traffic is split out and focus on the next non-helper sampled PCs, likely the `0x800F1438`/`0x800E2E34` task/resource staging path.
