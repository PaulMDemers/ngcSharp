...
static void PrintUsage()
{
    ...
    Console.WriteLine($"  ngcsharp run-dol <path-to-dol> [--max-instructions <n>] [--trace] [--trace-file <path>] [--trace-tail <n>] [--dump-mmio] [--dump-threads] [--dump-message-queues] [--dump-memory <addr> <len>] [--dump-disasm <addr> <count>] [--dump-pointer-table <addr> <count> <stride> <ptr-offset> <target-words>] [--dump-frame <png-path>] [--dump-gx-frame <png-path>] [--dump-gx-frame-sweep <dir> <start-skip> <step> <count>] [--gx-frame-source <efb|auto|last-display-copy|last-nonblack-display-copy|largest-display-copy|last-nonblack-efb|vi-framebuffer|last-nonblack-vi-framebuffer|copy-index|copy-source-index>] [--gx-frame-copy-index <n>] [--gx-frame-max-draws <n, default {RunDolOptions.DefaultGxFrameMaxDraws}>] [--gx-frame-skip-draws <n>] [--gx-frame-max-raster-pixels <n, default {RunDolOptions.DefaultGxFrameMaxRasterPixels}>] [--gx-frame-ignore-efb-copy-clear] [--dump-gx-draws <txt-path>] [--dump-gx-copies <csv-path>] [--dump-gx-coverage <csv-path>] [--dump-gx-tev-samples <csv-path>] [--dump-gx-textures <dir>] [--gx-draw-skip-draws <n>] [--gx-draw-max-draws <n, default {RunDolOptions.DefaultGxDrawMaxDraws}>] [--trace-gx-fifo-writes <csv-path>] [--gx-memory-checkpoint <fifo-offset> <addr> <len> <path>] [--gx-disable-auto-texture-snapshots] [--trace-exi <csv-path>] [--trace-si <csv-path>] [--trace-mmio <csv-path>] [--trace-scheduler <csv-path>] [--run-summary <json-path>] [--memory-card-a] [--memory-card-b] [--frame-address <addr>] [--frame-width <n>] [--frame-height <n>] [--frame-format <rgb565|yuyv|uyvy|xrgb8888>] [--watch-address <addr>] [--watch-write-value <value>] [--watch-write-range <addr> <len>] [--watch-write-after <n>] [--watch-load-range <addr> <len>] [--stop-after-write-watch <n>] [--watch-call-target <addr>] [--watch-call-range <addr> <len>] [--find-memory-word <value>] [--watch-gpr <r0-r31>] [--watch-gpr-after <n>] [--fast-forward-idle] [--fast-forward-write-watch] [--trace-prs-decompress] [--trace-sonic-path-lookup <csv-path>] [--di-command-latency-cycles <n>] [--controller-button <name|mask>] [--controller-buttons <mask>] [--controller-button-window <name|mask> <start> <end>] [--watch-limit <n>] [--profile-pc <n>] [--profile-after <n>] [--profile-indirect-call-site <addr> <n>] [--profile-branch-site <addr> <n>] [--profile-pc-lr <addr> <n>] [--stop-on-pc <addr>] [--stop-on-pc-after <n>] [--trace-pc <addr>] [--trace-pc-after <n>] [--stop-on-gx-fifo-offset <n>] [--stop-on-hot-pc <n>] [--stop-on-hot-pc-after <n>] [--no-registers] [--quiet]");
    Console.WriteLine("  ngcsharp run-disc <path-to-iso-gcm-rvz> [--max-instructions <n>] [--trace] [--trace-file <path>] [--trace-tail <n>] [--dump-mmio] [--dump-threads] [--dump-message-queues] [--dump-memory <addr> <len>] [--dump-disasm <addr> <count>] [--dump-pointer-table <addr> <count> <stride> <ptr-offset> <target-words>] [--dump-gx-frame <png-path>] [--dump-gx-frame-sweep <dir> <start-skip> <step> <count>] [--gx-frame-source <efb|auto|last-display-copy|last-nonblack-display-copy|largest-display-copy|last-nonblack-efb|vi-framebuffer|last-nonblack-vi-framebuffer|copy-index|copy-source-index>] [--gx-frame-copy-index <n>] [--gx-frame-max-draws <n>] [--gx-frame-skip-draws <n>] [--gx-frame-max-raster-pixels <n>] [--gx-frame-ignore-efb-copy-clear] [--dump-gx-draws <txt-path>] [--dump-gx-copies <csv-path>] [--dump-gx-coverage <csv-path>] [--dump-gx-tev-samples <csv-path>] [--dump-gx-textures <dir>] [--gx-draw-skip-draws <n>] [--gx-draw-max-draws <n>] [--trace-gx-fifo-writes <csv-path>] [--gx-memory-checkpoint <fifo-offset> <addr> <len> <path>] [--gx-disable-auto-texture-snapshots] [--trace-exi <csv-path>] [--trace-si <csv-path>] [--trace-mmio <csv-path>] [--trace-scheduler <csv-path>] [--run-summary <json-path>] [--memory-card-a] [--memory-card-b] [--watch-address <addr>] [--watch-write-value <value>] [--watch-write-range <addr> <len>] [--watch-write-after <n>] [--watch-load-range <addr> <len>] [--stop-after-write-watch <n>] [--watch-call-target <addr>] [--watch-call-range <addr> <len>] [--find-memory-word <value>] [--watch-gpr <r0-r31>] [--watch-gpr-after <n>] [--fast-forward-idle] [--fast-forward-write-watch] [--trace-prs-decompress] [--trace-sonic-path-lookup <csv-path>] [--di-command-latency-cycles <n>] [--controller-button <name|mask>] [--controller-buttons <mask>] [--controller-button-window <name|mask> <start> <end>] [--watch-limit <n>] [--profile-pc <n>] [--profile-after <n>] [--profile-indirect-call-site <addr> <n>] [--profile-branch-site <addr> <n>] [--profile-pc-lr <addr> <n>] [--stop-on-pc <addr>] [--stop-on-pc-after <n>] [--trace-pc <addr>] [--trace-pc-after <n>] [--stop-on-gx-fifo-offset <n>] [--stop-on-hot-pc <n>] [--stop-on-hot-pc-after <n>] [--no-registers] [--quiet]");
