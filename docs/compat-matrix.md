...
- Optional `expected` milestones such as `stopReason`, final `pc`, `topPc`, `minTopPcCount`, `nonExternalInterruptTopPc`, `minNonExternalInterruptTopPcCount`, `branchSite`, `branchSiteTopTarget`, `minBranchSiteTopTargetCount`, `pcLrSite`, `pcLrTopLr`, `minPcLrTopLrCount`, `sonicStateByte47`, `minPrsDecompressInstructions`, `minResourceLookupInstructions`, `minTimeBaseReadInstructions`, `minExternalInterruptLeafInstructions`, `minSonicResourceModeQueryInstructions`, `minSonicResourceStatePollInstructions`, `minSonicModeWrapperInstructions`, `minSonicResourceFixupInstructions`, `minSonicOverlayInactiveSlotScanInstructions`, `minSonicPathRecordScanInstructions`, `minSonicPairedTransform2dInstructions`, `minSonicPairedTransform4dInstructions`, `minSonicVectorBlendCopyInstructions`, `minSonicGeneratedModelPointerScanInstructions`, `minSonicGeneratedRangeScanInstructions`, `minSonicGxTexObjLoadNoCallbackInstructions`, `minSonicGxFloatStripEmitInstructions`, `minSonicGxFloatAttributeStripEmitInstructions`, `minSonicGxDrawBeginInstructions`, `minSonicGxIndexedStripDrawBeginInstructions`, `minSonicGxIndexedStripTailInstructions`, `minSonicGxFloatTexcoordStripEmitInstructions`, `minGxFifoBytes`, `minRenderedQuads`, `minRenderedTriangles`, `frameSource`, `frameSourceAddress`, `frameSourceCopyIndex`, `minDisplayCopies`, `minTextureCopies`, `minNonblackDisplayCopies`, `minMaxDisplayNonblack`, or `frameSha256`.
...
- Profile targets surface structured `topPc`, `topPcCount`, filtered non-external-interrupt top PCs, the first branch-site top target, a compact all-branch-site target summary, PC-to-LR caller profiles, processor interrupt cause/mask, DI status/command state, pending DI command detail, recent DI command history, recent PI/DI MMIO accesses, EXI channel state, Sonic resource-state fields, PRS decompression, resource-lookup, timebase-read, external-interrupt leaf, Sonic resource mode-query, Sonic resource state-poll, and Sonic mode-wrapper counters in `summary.csv`.
