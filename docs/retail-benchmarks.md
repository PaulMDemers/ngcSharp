...
- Disassemble/profile the `0x800E78AC` / `0x800E78D4` hot path now that PRS decode is structured and fast-forwarding; determine whether it is another exact helper loop, resource staging work, or a real subsystem dependency.
